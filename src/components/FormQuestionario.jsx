...
const handleChange = e =>{
    ...
    return(
        <DivForm>
        <h1>Incluir questionário</h1>
        <form onSubmit={handleSubmit}>
            
            <input type="text" 
            name="questaoUm" 
            value={novo.questaoUm}
            placeholder="questaoUm" 
            ...
            type="text" 
            name="questaoDois" 
            value={novo.questaoDois}
            placeholder="questaoDois" 
            onChange={handleChange}
            /> 
            <br/>
            ...
            <input type="text" 
            name="questaoTres" 
            value={novo.questaoTres}
            placeholder="questaoTres" 
            onChange={handleChange}
            /> <br/>
            
            <input type="text" 
            name="questaoQuatro" 
            value={novo.questaoQuatro}
